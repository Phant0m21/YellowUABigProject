  ...
  return <SafeAreaView style={styles.safe}><StatusBar style="light" />
    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
      ...
      <View style={styles.content}>
        ...
        <Pressable style={styles.filter}><Text style={styles.filterText}>Фільтри</Text><Ionicons name="chevron-down" size={21} color="#5e51ff" /></Pressable>
        ...
        <View style={styles.grid}>{catalogProducts.map((product, index) => <CatalogProductCard product={product} index={index} key={product.id} />)}</View>
